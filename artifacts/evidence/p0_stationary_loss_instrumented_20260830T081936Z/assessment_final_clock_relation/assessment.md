...
| device_host_offset | not_measured | None |
...
Device/host elapsed-clock relation:
- depth: status=measured, relative_rate=0.9825725255674892, absolute_offset_ns=None
- imu: status=measured, relative_rate=0.9932045610412917, absolute_offset_ns=None
- left: status=measured, relative_rate=0.9825725255674892, absolute_offset_ns=None
- rgb: status=measured, relative_rate=0.9953146896150135, absolute_offset_ns=None
- right: status=measured, relative_rate=0.9825725255674892, absolute_offset_ns=None
